...
class TreatmentDialog : DialogFragmentWithDate() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.insulin.setParams(
            savedInstanceState?.getDouble("insulin")
                ?: 0.0, 0.0, maxInsulin, pumpDescription.bolusStep, decimalFormatter.pumpSupportedBolusFormat(activePlugin.activePump.pumpDescription.bolusStep), false, binding.okcancel.ok, textWatcher
        )
    ...
    override fun submit(): Boolean {
        ...
        if (insulinAfterConstraints > 0) {
            actions.add(rh.gs(info.nightscout.core.ui.R.string.bolus) + ": " + decimalFormatter.toPumpSupportedBolus(insulinAfterConstraints, activePlugin.activePump.pumpDescription.bolusStep)
                .formatColor(context, rh,
