...
class InsulinDialog : DialogFragmentWithDate() {
    ...
    override fun submit(): Boolean {
        ...
        if (insulinAfterConstraints > 0) {
            actions.add(rh.gs(info.nightscout.core.ui.R.string.bolus) + ": " + decimalFormatter.toPumpSupportedBolus(insulinAfterConstraints, activePlugin.activePump.pumpDescription.bolusStep).formatColor(context, rh, info.nightscout.core.ui.R.attr.bolusColor))
