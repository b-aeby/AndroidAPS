...
class DataHandlerMobile @Inject constructor(
    ...
    private fun sendStatus() {
        ...
        if (config.appInitialized && profile != null) {
            ...
            currentBasal =
                iobCobCalculator.getTempBasalIncludingConvertedExtended(System.currentTimeMillis())?.toStringShort(decimalFormatter) ?: rh.gs(info.nightscout.core.ui.R.string.pump_base_basal_rate, profile
                    .getBasal())
