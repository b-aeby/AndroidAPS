...
class PersistentNotificationPlugin @Inject constructor(
    ...
    private fun updateNotification() {
        ...
        if (profileFunction.isProfileValid("Notification")) {
            ...
            line2 =
                rh.gs(info.nightscout.core.ui.R.string.treatments_iob_label_string) + " " + decimalFormatter.to2Decimal(bolusIob.iob + basalIob.basaliob) + "U " + rh.gs(info.nightscout.core.ui.R
                                                                                                                                                                             .string.cob) + ": " + iobCobCalculator.getCobInfo(
