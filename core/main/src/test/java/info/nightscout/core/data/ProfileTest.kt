...
//        Assertions.assertEquals(5.0, p.getTargetHighTimeFromMidnight(2 * 60 * 60), 0.01)
        ...
        Assertions.assertEquals(18.0, profileUtil.fromMgdlToUnits(18.0, GlucoseUnit.MGDL), 0.01)
        Assertions.assertEquals(1.0, profileUtil.fromMgdlToUnits(18.0, GlucoseUnit.MMOL), 0.01)
        ...
        Assertions.assertEquals("18", profileUtil.fromMgdlToUnitsString(18.0, 1.0, GlucoseUnit.MGDL))
        Assertions.assertEquals("1,0", profileUtil.fromMgdlToUnitsString(18.0, 1.0, GlucoseUnit.MMOL).replace(".", ","))
